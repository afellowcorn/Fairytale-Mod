...
def get_version_info():
    if get_version_info.instance is None:
        ...
        get_version_info.instance = VersionInfo(is_source_build, release_channel, version_number, mod_version, upstream, is_itch, is_sandboxed)
...
class VersionInfo:
    def __init__(self, is_source_build: bool, release_channel: str, version_number: str, mod_version: str, upstream: str, is_itch: bool, is_sandboxed: bool):
