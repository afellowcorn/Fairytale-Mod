    ...
    try:
        if cat.species == "regular cat":
            ...
            if cat.pelt.name not in ['Tortie', 'Calico']:
                ...
                patches = sprites.sprites[
                    tortie_pattern + cat.pelt.tortiecolour + cat_sprite].copy()
                patches.blit(sprites.sprites["tortiemask_wng" + cat.pelt.pattern + cat_sprite], (0, 0),
                             special_flags=pygame.BLEND_RGBA_MULT)
            ...
            # draw white patches
            if cat.pelt.white_patches is not None:
                white_patches = sprites.sprites['white_wng' + cat.pelt.white_patches + cat_sprite].copy()
            ...
            if cat.pelt.points:
                points = sprites.sprites['white_wng' + cat.pelt.points + cat_sprite].copy()
                if cat.pelt.white_patches_tint != "none" and cat.pelt.white_patches_tint in sprites.white_patches_tints[
                    "tint_colours"]:
                    tint = pygame.Surface((sprites.size, sprites.size)).convert_alpha()
                    tint.fill(tuple(sprites.white_patches_tints["tint_colours"][cat.pelt.white_patches_tint]))
            ...
            if cat.pelt.vitiligo:
                new_sprite.blit(sprites.sprites['white_wng' + cat.pelt.vitiligo + cat_sprite], (0, 0))

            # draw eyes & scars1
            eyes = sprites.sprites['eyes_wng' + cat.pelt.eye_colour + cat_sprite].copy()
            if cat.pelt.eye_colour2 != None:
                eyes.blit(sprites.sprites['eyes2_wng' + cat.pelt.eye_colour2 + cat_sprite], (0, 0))
            new_sprite.blit(eyes, (0, 0))
            ...
            # draw white patches
            if cat.pelt.white_patches is not None:
                white_patches = sprites.sprites['white_wurm' + cat.pelt.white_patches + cat_sprite].copy()
            ...
            if cat.pelt.points:
                points = sprites.sprites['white_wurm' + cat.pelt.points + cat_sprite].copy()
                if cat.pelt.white_patches_tint != "none" and cat.pelt.white_patches_tint in sprites.white_patches_tints[
                    "tint_colours"]:
                    tint = pygame.Surface((sprites.size, sprites.size)).convert_alpha()
                    tint.fill(tuple(sprites.white_patches_tints["tint_colours"][cat.pelt.white_patches_tint]))
            ...
            if cat.pelt.vitiligo:
                new_sprite.blit(sprites.sprites['white_wurm' + cat.pelt.vitiligo + cat_sprite], (0, 0))

            # draw eyes & scars1
            eyes = sprites.sprites['eyes_wurm' + cat.pelt.eye_colour + cat_sprite].copy()
            if cat.pelt.eye_colour2 != None:
                eyes.blit(sprites.sprites['eyes2_wurm' + cat.pelt.eye_colour2 + cat_sprite], (0, 0))
            new_sprite.blit(eyes, (0, 0))
            ...
            if not dead:
                ...
                new_sprite.blit(sprites.sprites['lineswurmdf' + cat_sprite], (0, 0))
            elif dead:
                new_sprite.blit(sprites.sprites['lineswurmdead' + cat_sprite], (0, 0))
            # draw skin and scars2
            blendmode = pygame.BLEND_RGBA_MIN
            new_sprite.blit(sprites.sprites['skin_wurm' + cat.pelt.skin + cat_sprite], (0, 0))
            
            if not scars_hidden:
                for scar in cat.pelt.scars:
                    if scar in cat.pelt.scars2:
                        new_sprite.blit(sprites.sprites['scars_wurm' + scar + cat_sprite], (0, 0), special_flags=blendmode)
