    ...
    def get_save_dict(self, faded=False):
        if faded:
            ...
            return {
                ...
                "alt_pelt_name": self.pelt.alt_name,
                "alt_pelt_color": self.pelt.alt_colour,
                ...
                "wing_pattern": self.pelt.wingpattern,
                "wing_color": self.pelt.wingcolour,
                "skin": self.pelt.skin,
                "antler": self.pelt.antler,
                "tint": self.pelt.tint,
